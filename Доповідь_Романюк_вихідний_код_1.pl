%Тут оголошуються факти, які вказують, хто є жінкою (female/1) і 
% хто є чоловіком (male/1). Слугує основою для інших відношень.
...
%son_in_law(X, Y) :- parent(Y, Z), married(X, Z).
